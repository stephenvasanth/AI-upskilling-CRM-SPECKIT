...
**Layout:** 4-column grid of metric cards, then 2-column grid below

**Components:**

#### Metric Cards (top row)
4 stat cards side by side in a 4-column grid:
- "Open Deals" — count of open deals
- "Pipeline Value" — total value of open deals (currency format, £ prefix)
- "Tasks Due Today" — count of tasks due today
- "New Contacts (7d)" — count of contacts added in the last 7 days
